...
The search model also has several other desirable properties. First, rather than returning a cleaned database instance the search returns a sequence of transformations. 
