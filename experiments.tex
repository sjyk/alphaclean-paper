...
\begin{figure}
    ...
    \caption{\small We analyze a dataset of terrorist attacks scraped from news sources since 1970. (A) A unified cleaning framework outperforms individual cleaning approaches and even a serial combination.  (B) \sys is easily parallelized to \ewu{XXX} threads to outperform the combined baselines.  \label{exp7a}}
\end{figure}
