...
\title{AlphaClean: Holistic Optimization of Data Cleaning Pipelines}

\numberofauthors{1}
\author{ Sanjay Krishnan$\,^{*}$ Eugene Wu{$\,^{\dag}$}  \\
\affaddr{ $^*$University of Chicago, $^\dag$Columbia University} \\
\affaddr{ skr@cs.uchicago.edu ~~ ewu@cs.columbia.edu}\\
\affaddr{}
}
